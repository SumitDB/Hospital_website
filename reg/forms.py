...
class CustomerReg(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'treatment_name_1': forms.TextInput(attrs={'class':'form-control','placeholder':'Name'}),
            'units_1': forms.TextInput(attrs={'class':'form-control','placeholder':'Units'}),
            'details_1': forms.TextInput(attrs={'class':'form-control','placeholder':'Details'}),
            'treatment_type_2': forms.Select(attrs={'class':'form-control'}),
            'treatment_name_2': forms.TextInput(attrs={'class':'form-control','placeholder':'Name'}),
            'units_2': forms.TextInput(attrs={'class':'form-control','placeholder':'Units'}),
            'details_2': forms.TextInput(attrs={'class':'form-control','placeholder':'Details'}),
            'treatment_type_3': forms.Select(attrs={'class':'form-control'}),
            'treatment_name_3': forms.TextInput(attrs={'class':'form-control','placeholder':'Name'}),
            'units_3': forms.TextInput(attrs={'class':'form-control','placeholder':'Units'}),
            'details_3': forms.TextInput(attrs={'class':'form-control','placeholder':'Details'}),
            'treatment_type_4': forms.Select(attrs={'class':'form-control'}),
            'treatment_name_4': forms.TextInput(attrs={'class':'form-control','placeholder':'Name'}),
            'units_4': forms.TextInput(attrs={'class':'form-control','placeholder':'Units'}),
            'details_4': forms.TextInput(attrs={'class':'form-control','placeholder':'Details'}),
